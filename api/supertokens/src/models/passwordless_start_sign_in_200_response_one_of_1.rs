...
pub struct PasswordlessStartSignIn200ResponseOneOf1 {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
}

impl PasswordlessStartSignIn200ResponseOneOf1 {
    pub fn new() -> PasswordlessStartSignIn200ResponseOneOf1 {
        PasswordlessStartSignIn200ResponseOneOf1 {
            status: None,
        }
    }
}
