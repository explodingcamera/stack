...
pub struct EmailPasswordGetPasswordResetTokenRequest {
    #[serde(rename = "userId", skip_serializing_if = "Option::is_none")]
    pub user_id: Option<String>,
}

impl EmailPasswordGetPasswordResetTokenRequest {
    pub fn new() -> EmailPasswordGetPasswordResetTokenRequest {
