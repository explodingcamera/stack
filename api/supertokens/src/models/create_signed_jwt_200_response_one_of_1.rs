...
pub struct CreateSignedJwt200ResponseOneOf1 {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
}

impl CreateSignedJwt200ResponseOneOf1 {
    pub fn new() -> CreateSignedJwt200ResponseOneOf1 {
        CreateSignedJwt200ResponseOneOf1 {
            status: None,
        }
    }
}
