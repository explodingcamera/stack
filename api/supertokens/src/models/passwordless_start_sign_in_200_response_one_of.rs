...
pub struct PasswordlessStartSignIn200ResponseOneOf {
...
impl PasswordlessStartSignIn200ResponseOneOf {
    pub fn new() -> PasswordlessStartSignIn200ResponseOneOf {
        PasswordlessStartSignIn200ResponseOneOf {
            status: None,
