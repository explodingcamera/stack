...
pub struct RemoveRolePermissions200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
}

impl RemoveRolePermissions200Response {
    pub fn new() -> RemoveRolePermissions200Response {
        RemoveRolePermissions200Response {
            status: None,
        }
    }
}
