...
pub struct CreateSignedJwt200ResponseOneOf {
...
impl CreateSignedJwt200ResponseOneOf {
    pub fn new() -> CreateSignedJwt200ResponseOneOf {
        CreateSignedJwt200ResponseOneOf {
            status: None,
            jwt: None,
        }
    }
